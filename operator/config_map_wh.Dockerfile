...
COPY ./config_map_webhook/templates/certs/ca.crt /config_map_webhook/certs/tls.crt
COPY ./config_map_webhook/templates/certs/ca.key /config_map_webhook/certs/tls.key
COPY ./api ./api
